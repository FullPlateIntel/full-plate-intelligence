...
build:
	python3 build/extract.py && python3 build/build.py && python3 build/apply_brand_favicon_html.py && python3 build/apply_steve_meta.py && python3 hosting/render-host-configs.py
serve:
